...
<body>
    ...
    <div class="search">
        <form action="searchBoard.jsp" name="searchBoard">
	        ...
	        <input type="button" value="전체보기" onclick="location.href='free_Board.jsp'">
	        <input type="hidden" value="1" name="groupn">
        </form>
    </div>
    <div class="write">
    ...
    <div class="table_div">
            ...
            <tbody>
             <%
	             ...
	             if(request.getParameter("searchContent") != null){
	            	 ...
	            	 community = commQuery.getCommunityList(1, pageNUM, searchType, searchContent);
	             }else{
	            	 community = commQuery.getCommunityList(1, pageNUM, 2, "");            	 
	             }
        ...
        <div class="page">
        	<%= CommunityBean.pageNumberFree(4) %>
        </div>
       </div>
</body>
    <script>
